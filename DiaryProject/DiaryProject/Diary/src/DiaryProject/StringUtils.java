...
/**
 * Utility class for managing the texts in program.
 */
public class StringUtils {
     ...
     * @param text Input that needs to check.
     * @return true if isn't null and empty, false otherwise.
     */
    ...
    /**
     * Shows a message for asking an input.
     * @param text_message Message that shows to user.
     * @param scan The Scanner object to read user input. 
     * @return user's input.
     */
    public static String askForString(String text_message, Scanner scan) {
        String userString;
        do {
